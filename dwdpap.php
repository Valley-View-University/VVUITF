...
{
   //  Logo
    $this->Image('res/images/logo.png',2,3,30);
    // Arial bold 15
    $this->SetFont('Arial','B',15);
    // Move to the right
    $this->Cell(80);
     //Title
    $this->Cell(60,5,'Valley View University information Technology Discussion Forum	',7, 3,'C');
    // Line break
    $this->Ln(4);
}
...
$pdf->MultiCell(0,20,'Institute of Computer Science','TB','C');
